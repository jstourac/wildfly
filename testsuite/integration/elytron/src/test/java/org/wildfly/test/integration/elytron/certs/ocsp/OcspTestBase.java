...
public class OcspTestBase extends CommonBase {
    ...
    protected static final String CA_JKS_LOCATION = "./target/test-classes/ca/jks";
    ...
    private static ConfigurableElement[] getConfigurableElementsCommon() {
        ...
        Path serverTrustStorePath = Path.builder().withPath(TRUST_FILE.getAbsolutePath()).build();
