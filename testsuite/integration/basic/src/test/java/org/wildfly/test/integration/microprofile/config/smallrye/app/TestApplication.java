...
public class TestApplication extends Application {
    ...
    public static class ResourceSimple {
        ...
        @Inject
        @ConfigProperty(name = "jboss.home", defaultValue = "System property not defined!")
        String systemProperty;

        @Inject
        @ConfigProperty(name = "JBOSS_HOME", defaultValue = "Environment variable not defined!")
        String envVariable;
        ...
        public Response doGet() {
            ...
            text.append("jboss.home = " + systemProperty + "\n");
            text.append("JBOSS_HOME = " + envVariable + "\n");
    ...
    public static class ResourceBoolean {
        ...
        @Inject
        @ConfigProperty(name = "boolNoDefault")
        private boolean boolNoDefault;
        ...
        @Inject
        @ConfigProperty(name = "booleanNoDefault")
        private boolean booleanNoDefault;
    ...
    public static class ResourceInteger {
        ...
        @Inject
        @ConfigProperty(name = "intNoDefault")
        private int intNoDefault;
        ...
        @Inject
        @ConfigProperty(name = "integerNoDefault")
        private Integer integerNoDefault;
    ...
    public static class ResourceLong {
        ...
        @Inject
        @ConfigProperty(name = "longNoDefault")
        private long longNoDefault;
        ...
        @Inject
        @ConfigProperty(name = "longClassNoDefault")
        private Long longClassNoDefault;
    ...
    public static class ResourceFloat {
        ...
        @Inject
        @ConfigProperty(name = "floatNoDefault")
        private float floatNoDefault;
        ...
        @Inject
        @ConfigProperty(name = "floatClassNoDefault")
        private Float floatClassNoDefault;
    ...
    public static class ResourceDouble {
        ...
        @Inject
        @ConfigProperty(name = "doubleNoDefault")
        private double doubleNoDefault;
        ...
        @Inject
        @ConfigProperty(name = "doubleClassNoDefault")
        private Double doubleClassNoDefault;
        ...
        public Response doGet() {
            ...
            text.append("doubleNoDefault = " + doubleNoDefault + "\n");
            ...
            text.append("doubleClassNoDefault = " + doubleClassNoDefault + "\n");
    ...
    @Path(ARRAY_SET_LIST_NO_DEF_APP_PATH)
    public static class ResourceArraySetListNoDefProps {

        @Inject
        Config config;

        @Inject
        @ConfigProperty(name = "NoDef")
        private String[] myArrayPetsNoDef;

        @Inject
        @ConfigProperty(name = "myPetsNoDef")
        private List<String> myListPetsNoDef;

        @Inject
        @ConfigProperty(name = "myPetsNoDef")
        private Set<String> mySetPetsNoDef;
        ...
        public Response doGet() {
            ...
            text.append("myPetsNonDef as String array = " + Arrays.toString(myArrayPetsNoDef) + "\n");
            text.append("myPetsNonDef as String list = " + myListPetsNoDef + "\n");
            text.append("myPetsNonDef as String set = " + mySetPetsNoDef + "\n");
